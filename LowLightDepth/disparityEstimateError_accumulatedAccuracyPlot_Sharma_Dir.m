...
for i=0:N
    ...
    if all(disparityGT == 0)
        ...
        correctK0_est_groundTruth         = nguyen_correct_0(disparityGT, disparityMapL, 0);
        correctK0_estEnhanced_groundTruth = nguyen_correct_0(disparityGT, disparityMapL_enhanced, 0);
    end

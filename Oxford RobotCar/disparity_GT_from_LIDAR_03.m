...
image_dir      = fullfile(root_path, '2014-11-14-16-34-33_03\stereo\left');
laser_dir      = fullfile(root_path, '2014-11-14-16-34-33_03\lms_front');
ins_file       = fullfile(root_path, '2014-11-14-16-34-33_03\gps\ins.csv');
...
timestamp_file = fullfile(root_path, '2014-11-14-16-34-33_03\stereo.timestamps');

imageFiles = dir('C:\Users\josep\OneDrive\Documents\MS Thesis\[Dataset] Oxford RobotCar\2014-11-14-16-34-33_03\stereo\left\*.png');
...
timestamp_to_run = 1415985706814901; % to run one timestamp - 1415985129080465
...
for timestamp_index = indices_to_run 
    ...
    if save_disparity_var
        ...
        savepath = strcat(root_path,'2014-11-14-16-34-33_03\stereo\left_disparity_var\',filename(1:end-4),'.mat');
    ...
    if save_disparity_image
        savepath = strcat(root_path,'2014-11-14-16-34-33_03\stereo\left_disparity_img\',imageFiles(timestamp_index).name);
